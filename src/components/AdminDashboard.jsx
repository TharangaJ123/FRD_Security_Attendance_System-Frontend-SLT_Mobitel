...
const AdminDashboard = () => {
  ...
  const menuItems = [
    ...
    {
      id: "assign-approval-officer",
      title: "Assign Patrol Leaders",
      icon: <MdAssignment />,
      roles: [UserRole.Super_Admin]
    },
    {
    ...
    <div className={`dashboard-container ${mobileMenuOpen ? 'mobile-menu-open' : ''}`}>
      ...
      <main className="main-content">
        ...
        <div className="content-container">
          ...
          {activeSection === "inventory-management" && <UserTable />}
          ...
          {activeSection === "assign-approval-officer" && <AssignPatrolLeaders />}
